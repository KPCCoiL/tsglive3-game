...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__12945){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__12949_SHARP_){
return (((p1__12949_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12949_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__12950,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__12950;
}
});
...
var G__12952 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12952,cljs.core.cst$kw$class,cljs.core.vec(classes));
} else {
return G__12952;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq12951){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12951));
});
...
var vec__12958 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_((function (){var G__12962 = cljs.core.ffirst(matches);
var fexpr__12961 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__12961.cljs$core$IFn$_invoke$arity$1 ? fexpr__12961.cljs$core$IFn$_invoke$arity$1(G__12962) : fexpr__12961.call(null,G__12962));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12958,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12958,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some(((function (matches,vec__12958,tag_name,names){
return (function (p1__12956_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__12956_SHARP_))){
return p1__12956_SHARP_;
} else {
return null;
}
});})(matches,vec__12958,tag_name,names))
,names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1(((function (matches,vec__12958,tag_name,names){
return (function (p1__12957_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__12957_SHARP_));
});})(matches,vec__12958,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__12964){
var vec__12965 = p__12964;
var seq__12966 = cljs.core.seq(vec__12965);
var first__12967 = cljs.core.first(seq__12966);
var seq__12966__$1 = cljs.core.next(seq__12966);
var tag = first__12967;
var content = seq__12966__$1;
...
var vec__12968 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12968,(2),null);
